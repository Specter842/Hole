...
def freelancing(conn: sqlite3.Connection, token: str) -> str:
    ...
    body=bar+'<div class="grid g2" style="margin-top:16px">'+E.panel("Add freelance opportunity", form, sub="Track projects by discipline")+E.panel("Coverage", E.bars([(label, sum(1 for r in rows if r["category"]==key)) for key,label in cats]), sub="Your saved opportunities")+'</div><div class="grid g2" style="margin-top:16px">'+columns+'</div>'
